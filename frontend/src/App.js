...
// Product Imports (for Admin Dashboard)
import ProductList from "./components/admin/ProductList";
import NewProduct from "./components/admin/NewProduct";
import UpdateProduct from "./components/admin/UpdateProduct";
import ProductReviews from "./components/admin/ProductReviews";

// Order Imports (for Admin Dashboard)
import OrderList from "./components/admin/OrderList";
import UpdateOrder from "./components/admin/UpdateOrder";

// Users Imports (for Admin Dashboard)
import UsersList from "./components/admin/UsersList";
import UpdateUser from "./components/admin/UpdateUser";


// Frontend Layout imports
...
// Import For Payment - third party
      ...
      <Router>
          <div className="App">
              ...
              <div className="container container-fluid">
                ...
                <Route path="/product/view/:id" component={ProductDetails} exact />
              ...
              <ProtectedRoute path="/admin/order/:id" isAdmin={true} component={UpdateOrder} exact />
